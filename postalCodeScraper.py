...
with open('Data-Part1.csv') as csv_file:
    ...
    for row in csv_reader:
        ...
        #    urls.append('')
        #else:
        urls.append(firstpart + row[1][:3]  + secondpart + row[1][:3] + thirdpart)
        line_count += 1
...
with open('age_income_children.csv', 'a') as csv_file:
    ...
    for page in urls:
        try:
            ...
            print(ratio)
            writer.writerow((age, income, ratio, youth_ratio))
